...
class Window(QDialog):
    ...
    def createBottomLeftTabWidget(self):
        ...
        tab2hbox.addWidget(speed)
        tab2hbox.addWidget(button_less)
        tab2hbox.addWidget(button_more)
        tab2hbox.addWidget(curr_val)
        tab2.setLayout(tab2hbox)

        direction = QLabel("Speed")
        button_CV = QPushButton("+")
        button_CCV = QPushButton("-")
        curr_val = QLabel(f'Current value: CV')

        tab3hbox = QHBoxLayout()
        tab3hbox.setContentsMargins(5, 5, 5, 5)
        tab3hbox.addWidget(speed)
        tab3hbox.addWidget(button_less)
        tab3hbox.addWidget(button_more)
        tab3hbox.addWidget(curr_val)
        tab2.setLayout(tab3hbox)

        self.bottomLeftTabWidget.addTab(tab1, "Devices")
        self.bottomLeftTabWidget.addTab(tab2, "Service")
